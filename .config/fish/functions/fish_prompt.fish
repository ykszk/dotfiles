function fish_prompt
  ...
  # Color the hostname in the prompt in red in SSH
  if set -q SSH_TTY
    set __fish_hostname_color (set_color FF0000)
  else
    set __fish_hostname_color (set_color 87ff00)
  end

  # Line
  echo -sne '\n'$purple$__fish_user' '$blue$USER$white \
    ' @ '$__fish_hostname_color$__fish_prompt_hostname$white \
